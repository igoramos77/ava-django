...
from .views import IndexView, DisciplinaView, EstatisticasView, RelatorioNotasView, DisciplinaViewSet, NotaViewSet, UsuarioViewSet, AvaliacaoiewSet
...
urlpatterns = [
    ...
    path('relatorio-notas/', RelatorioNotasView.as_view(), name='relatorio-notas'),
]
